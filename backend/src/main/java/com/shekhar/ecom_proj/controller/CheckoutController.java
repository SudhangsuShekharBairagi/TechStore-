...
public class CheckoutController {
    ...
    public ResponseEntity<?> addCart(@PathVariable Integer id, @RequestParam int quantity){

        try {
            service.checkItemsQuantity(id, quantity);
            return ResponseEntity.ok("Product Available");
