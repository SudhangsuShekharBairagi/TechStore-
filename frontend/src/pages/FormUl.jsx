      ...
      <div className="mx-auto max-w-5xl">
        <div className="overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-[0_25px_80px_-25px_rgba(15,23,42,0.35)]">
          <div className="bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-500 px-8 py-8 text-white sm:px-10">
            ...
            <p className="mt-2 text-indigo-100">Fill in the product details below</p>
          </div>
          ...
          <form onSubmit={submitHandler} className="space-y-6 p-8 sm:p-10">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                <label className="mb-2 block text-sm font-semibold text-slate-700">Release Date</label>
                <input
                  type="date"
                  name="releaseDate"
              ...
              {productOparation === "Update The Product" ? (
                <div className="flex flex-col gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  {imgPreview ? <img src={imgPreview} className="h-40 w-full rounded-2xl object-cover" /> : <img src={image} className="h-40 w-full rounded-2xl object-cover" />}
                  <div>
                    <label className="mb-2 block text-sm font-semibold text-slate-700">Change The Image</label>
                    <input
                      id="image"
                      type="file"
                      accept="image/*"
